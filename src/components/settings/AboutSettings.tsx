...
export function AboutSettings() {
  ...
  const hasUpdate =
    latestRelease !== null && compareVersions(latestRelease.version, currentVersion) > 0;
            ...
            <div className="space-y-3">
              ...
              {latestRelease.publishedAt && (
                <div className="text-sm text-[var(--text-muted)]">
                  发布时间：{new Date(latestRelease.publishedAt).toLocaleDateString('zh-CN')}
                </div>
              )}
              ...
              <button
                ...
                onClick={() => openUrl(latestRelease.url)}
              >
                前往 GitHub 下载
              </button>
            </div>
