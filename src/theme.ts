...
const warmCarbon: ThemePresetDefinition = {
  ...
  ui: {
    ...
    '--color-error': '#d4605a',
    '--diff-add-bg': 'rgba(107, 184, 122, 0.16)',
    '--diff-add-text': '#a8dfb2',
    '--diff-add-inline-bg': 'rgba(107, 184, 122, 0.28)',
    '--diff-add-inline-text': '#e4f7e8',
    '--diff-del-bg': 'rgba(212, 96, 90, 0.16)',
    '--diff-del-text': '#f0b5af',
...
const ghosttyDark: ThemePresetDefinition = {
  ...
  ui: {
    ...
    '--color-error': '#e06a6a',
    '--diff-add-bg': 'rgba(108, 197, 138, 0.16)',
    '--diff-add-text': '#9ae0b3',
    '--diff-add-inline-bg': 'rgba(108, 197, 138, 0.30)',
    '--diff-add-inline-text': '#ebfff1',
    '--diff-del-bg': 'rgba(224, 106, 106, 0.16)',
    '--diff-del-text': '#f2b1b1',
...
const ghosttyLight: ThemePresetDefinition = {
  ...
  ui: {
    ...
    '--color-error': '#c54d50',
    '--diff-add-bg': 'rgba(47, 150, 98, 0.14)',
    '--diff-add-text': '#176340',
    '--diff-add-inline-bg': 'rgba(47, 150, 98, 0.22)',
    '--diff-add-inline-text': '#0d4c2f',
    '--diff-del-bg': 'rgba(197, 77, 80, 0.14)',
    '--diff-del-text': '#8f2328',
